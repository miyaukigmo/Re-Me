                ...
                <AnimatePresence mode="wait">
                    {currentQuote && !isAnimating && (
                        <motion.div
                            ...
                            onClick={handleNext}
                            className="relative w-full max-w-[340px] h-[580px] bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 flex flex-col overflow-hidden cursor-pointer active:scale-[0.98]"
                        >
                            {/* Main Content Area */}
                            <div className="flex-1 flex flex-col p-8 overflow-hidden">

                                {/* Quote Area */}
                                <div className="h-[170px] shrink-0 w-full overflow-y-auto no-scrollbar flex items-start justify-center pt-2">
                                ...
                                <div className="flex-1 w-full flex flex-col relative overflow-hidden mt-1">
                                    {editMode !== 'none' ? (
                                        <div className="flex flex-col gap-2 animate-in fade-in slide-in-from-bottom-2 duration-200 w-full h-full" onClick={e => e.stopPropagation()}>
                                        ...
                                        <div className="flex-1 overflow-y-auto no-scrollbar py-2 flex flex-col gap-4">
                                            {/* Note */}
                                            {currentQuote.note && (
